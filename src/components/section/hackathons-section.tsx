        ...
        <div className="flex flex-col gap-y-4 items-center justify-center">
          ...
          <div className="flex flex-col gap-y-3 items-center justify-center">
            ...
            <p className="text-muted-foreground md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed text-balance text-center">
              Durante a universidade, participei de mais de {DATA.hackathons.length}
              hackathons. Pessoas de todo o país se reuniam para construir coisas
              incríveis em 2 ou 3 dias. Foi inspirador ver as possibilidades
              criadas por pessoas motivadas e apaixonadas.
            </p>
          </div>
        </div>
        <Timeline>
